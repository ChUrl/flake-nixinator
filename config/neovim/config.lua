...
require("lazy").setup({
    ...
    colorscheme catppuccin
        ...
        {
            "jdtls",
            dir = "/home/lab/smchurla/Downloads/flake-nixinator/config/neovim/store/lazy-plugins/nvim-jdtls",
            lazy = false,
            name = "jdtls",
        },
        {
            ...
            callback = function()
                ...
                local opts = {
                    ...
                    cmd = {
                        "jdtls",
                        "-data",
                        "/home/lab/smchurla/.local/share/eclipse/" .. vim.fn.fnamemodify(workspace, ":p:h:t"),
                    },
                }
