...
require("lualine").setup({
    ...
    ["sections"] = {
        ...
        ["lualine_z"] = { { "location", ["left_padding"] = "2", ["separator"] = { ["right"] = "" } } },
    },
...
require("neo-tree").setup({
    ["buffers"] = { ["bind_to_cwd"] = true, ["follow_current_file"] = { ["enabled"] = true } },
...
require("nvim-navic").setup({ ["click"] = true, ["highlight"] = true })
